<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="idUsuario" class="form-control @error('idUsuario') is-invalid @enderror" value="{{ old('idUsuario', $cliente?->idUsuario) }}" id="id_usuario" placeholder="Idusuario">
